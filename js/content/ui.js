...
const TooltipManager = {
  ...
  renderWrapper: function(el, handle, displayName, fullName, subs, isExpired) {
      ...
      Object.assign(nameNode.style, {
          color: computedStyle.color, fontFamily: computedStyle.fontFamily, fontSize: computedStyle.fontSize,
          fontWeight: "bold", lineHeight: "1.4", marginBottom: "2px"
      });
  ...
  // =======================================================
  renderEmbedded: function(target, handle, displayName, fullName, subs, isExpired) {
  ...
  bindCopyEvent: function(element, handle) {
      ...
      element.addEventListener("click", async (e) => {
          ...
          try {
              await navigator.clipboard.writeText(`https://www.youtube.com/${handle}`);
  ...
  showToast: function(msg) {
     if (this.tooltipEl) {
         ...
         setTimeout(() => { this.tooltipEl.style.opacity = 0; }, 1500);
     }
  },
  ...
  getBadgeIcon: function(subs) {
      ...
      Object.assign(i.style, { display:"inline-block", width:"8px", height:"8px", borderRadius:"50%", marginLeft:"2px" });
      
      if (subs >= 1000000) { i.style.background = "#00BFA5"; i.title = "百萬訂閱"; }
      else if (subs >= 100000) { i.style.background = "#FFD700"; i.title = "十萬訂閱"; }
      else if (subs >= 10000) { i.style.background = "#C0C0C0"; i.title = "萬人訂閱"; }
      else if (subs >= 1000) { i.style.background = "#CD7F32"; i.title = "千人訂閱"; }
      else { i.style.background = "#8D6E63"; i.title = "潛力頻道"; }
      return i;
  },
  ...
  createTooltipElement: function() {
    ...
    Object.assign(el.style, {
      ...
      padding: "10px 14px", borderRadius: "12px", fontFamily: "'Roboto', sans-serif", fontSize: "13px",
      lineHeight: "1.5", whiteSpace: "normal", maxWidth: "300px", wordBreak: "break-word", 
      transition: "opacity 0.2s cubic-bezier(0.2, 0, 0.2, 1), transform 0.2s", 
      opacity: 0, transform: "translateY(5px)", boxShadow: "0 8px 32px 0 rgba(0, 0, 0, 0.25)", 
      backdropFilter: "blur(8px)", webkitBackdropFilter: "blur(8px)",
      border: "1px solid rgba(255, 255, 255, 0.18)", background: "rgba(28, 28, 28, 0.85)", color: "#ffffff",
      textAlign: "left"
    });
  ...
  show: function(e, target) {
    ...
    Object.assign(nameDiv.style, { fontWeight: "600", fontSize: "1.1em", marginBottom: "2px" });
    nameDiv.textContent = name;
    this.tooltipEl.appendChild(nameDiv);

    if (handle) {
        const handleDiv = document.createElement("div");
        Object.assign(handleDiv.style, { color: "inherit", opacity: "0.7", fontSize: "0.9em", fontFamily: "monospace" });
    ...
    if (subs > 0) {
        ...
        Object.assign(subsDiv.style, { marginTop: "6px", fontSize: "0.85em", display: "flex", alignItems: "center", gap: "4px" });
    ...
    if (isExpired) {
        ...
        Object.assign(expDiv.style, { marginTop: "6px", paddingTop: "4px", borderTop: "1px dashed rgba(128,128,128,0.3)", color: "#ffab91", fontSize: "0.85em" });
